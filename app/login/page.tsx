...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-[100dvh] items-center justify-center bg-gradient-to-br from-primary-900 via-primary-800 to-primary-900 p-4">
        ...
        <div className="rounded-2xl border border-primary-700/50 bg-primary-800/50 p-8 backdrop-blur-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="mt-1 text-right">
              <a href="/login/forgot-password" className="text-xs text-primary-200 hover:text-white transition-colors">
                Forgot password?
              </a>
            </div>
